...
public class PlayerManager : MonoBehaviour
{
    ...
    public bool canMove; //코루틴 반복을 방지하는 플래그
    ...
    IEnumerator TeleportSetCoroutine()
    {
        ...
        {
            if (i != 6) theTM.tiles[i].cardActive = true; //모든 카드(텔레포트 타일 제외) 클릭 가능하도록 미리 클릭하고 다음턴에 해당 위치로 이동.
        }
    ...
    public IEnumerator LargerPlayer()
    {
