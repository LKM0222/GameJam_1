...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            turnCards[0].GetComponent<TurnCard>().turnNum = 1;
            turnCards[1].GetComponent<TurnCard>().turnNum = 2;
        }
        else
        {
            turnCards[0].GetComponent<TurnCard>().turnNum = 2;
            turnCards[1].GetComponent<TurnCard>().turnNum = 1;
        }
    }
