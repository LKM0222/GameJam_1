...
public class PlayerStat : MonoBehaviour
{
    ...
    // 플레이어가 건설한 건물
    public List<Building63> buildings;

    // 플레이어가 매입한 토지, 우측 하단을 기준으로 시계 방향으로 0번부터 ID를 부여함
    public int[] groundID;

    // 플레이어가 보유하고 있는 카드
    List<CardCherry> cards;
    ...
    // 빌딩 건설 함수
    public void AddBuilding(Building63 _building)
    {
    ...
    // 카드 추가 함수
    public void AddCard(CardCherry _card)
    {
        cards.Add(_card);
    }
    ...
    // 플레이어가 보스를 공격하는 함수
    public void PlayerAttack(int _dmg)
    {
